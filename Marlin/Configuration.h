...
#define STRING_CONFIG_H_AUTHOR "(Jovanni Carr, Ender-3 Pro)" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Jo-awesome's Ender-3 Pro V1.5 (4.2.7)"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 420.6 }
